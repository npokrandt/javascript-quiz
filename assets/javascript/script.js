...
// array.push(buildQuestion("Which of the following is not a primitive data type in JS?", true, ['boolean', 'float', 'symbol', 'undefined'], 'float'))
// console.log(array)
    ...
    //remove old question
        //if it is the last question
            ...
            function startGame(){
                ...
                var questionPrompt = question[0].prompt
                var options = question[0].possibleAnswers
                buildQuestion(questionPrompt, options)
            }
...
body.addEventListener("click", submitAnswer)
